...
output "workload_identity_provider" {
  description = "Full resource path of the Workload Identity Provider Nullify will use to exchange OIDC subject tokens for GCP access tokens. Paste this into the Nullify console."
  value       = "projects/${data.google_project.host.number}/locations/global/workloadIdentityPools/${google_iam_workload_identity_pool.nullify.workload_identity_pool_id}/providers/${google_iam_workload_identity_pool_provider.nullify_oidc.workload_identity_pool_provider_id}"
}
